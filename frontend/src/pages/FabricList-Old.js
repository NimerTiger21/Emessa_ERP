...
const FabricList = () => {
  ...
  }, [selectedSupplier, search, sort]); // Add all filters/search/sort dependencies here
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      {selectedSupplier && (
        <p className="mb-4 text-sm text-gray-600">
          Showing results for supplier <strong>{selectedSupplier.name}</strong> on page <strong>{pagination.page}</strong>.
        </p>
      )}
        {/* Create Button */}
        <button
          ...
          <thead>
            <tr className="bg-gray-200 text-gray-700">
              <th
                ...
                className="border cursor-pointer p-3 text-left"
              >
                Fabric Name{" "}
