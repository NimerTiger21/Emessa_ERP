...
const DefectDetail = () => {
  ...
  const prevImage = () => {
    ...
    setCurrentImageIndex(
      (prev) => (prev - 1 + defect.images.length) % defect.images.length
    );
    resetImageSettings();
  };
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-50">
        <div className="text-center bg-white p-8 rounded-lg shadow-lg max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            The requested defect could not be found or may have been removed.
          </p>
          <Link
            to="/defects"
            className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700"
          ...
          >
            {defect.images && defect.images.length > 0 && (
              <img
                ...
                className="absolute"
                style={{
                  transform: `rotate(${rotationAngle}deg) scale(${zoomLevel}) translate(${
              ...
              <div className="mt-4 grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-3 rounded">
                  ...
                  <p className="font-medium">
                    {defect.defectPlace?.name || "Not specified"}
                  </p>
                </div>
                <div className="bg-gray-50 p-3 rounded">
                  <p className="text-sm text-gray-500">Position</p>
                  <p className="font-medium">
                    {defect.defectProcess?.name || "Not specified"}
                  </p>
                </div>
              </div>
            </div>
            {/* // Updated defect detail view section ***********************####################################************************ */}
            {/* Location details */}
            <div className="mt-4">
              {defect.details && defect.details.length > 0 ? (
                // Show detailed breakdown when details exist
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm text-gray-500">
                      {defect.details.length} location
                      {defect.details.length > 1 ? "s" : ""}
                    </span>
                  </div>

                  <div className="space-y-3">
                    {defect.details.map((detail, index) => (
                      <div
                        key={index}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <p className="font-medium text-gray-800">
                              📍 {detail.defectPlace?.name || "Not specified"}
                            </p>
                          </div>
                          <div>
                            <p className="text-sm text-gray-500 mb-1">
                            ...
                            <p className="font-medium text-gray-800">
                              ⚙️ {detail.defectProcess?.name || "Not specified"}
                            </p>
                          </div>
                        </div>
                ...
                // Show original simple view when no details exist
                <div>
                        ...
                        <div className="space-y-3">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {defect.defectName?.name || "Unknown"}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-500">Category:</span>
                            <span className="font-medium">
                              {defect.defectType?.name || "Unknown"}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {defect.rootCause || "Not determined"}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {defect.orderId?.fabric?.name || "Not specified"}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {defect.productionDate
                                ? format(
                                    new Date(defect.productionDate),
                                    "MMM dd, yyyy"
                                  )
                                : "N/A"}
                            </span>
                ...
                {activeTab === "comments" && (
                  <div>
                    <p className="text-gray-500 text-center py-8">
                      Comments feature is currently under development.
                    </p>
