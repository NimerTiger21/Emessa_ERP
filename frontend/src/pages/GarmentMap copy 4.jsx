...
import { RotateCcw, RotateCw, Eye, EyeOff, TrendingUp, AlertTriangle, MapPin, Layers, Activity, BarChart3 } from 'lucide-react';
...
const TrouserHeatMap = ({ defectData = [] }) => {
  ...
  // Mock defect data with locations - in real app, this would come from props
  const mockDefectData = [
    { id: 1, component: 'Front Left Pocket', side: 'front', x: 27, y: 40, severity: 'High', count: 12, type: 'Stitching' },
    { id: 2, component: 'Right Knee Area', side: 'front', x: 70, y: 60, severity: 'Medium', count: 8, type: 'Fabric' },
    { id: 3, component: 'Waistband', side: 'front', x: 50, y: 10, severity: 'Critical', count: 15, type: 'Construction' },
    { id: 4, component: 'Back Pocket Right', side: 'back', x: 65, y: 35, severity: 'Low', count: 5, type: 'Stitching' },
    { id: 5, component: 'Back Seam', side: 'back', x: 50, y: 70, severity: 'High', count: 10, type: 'Seam' },
    { id: 6, component: 'Hem Left', side: 'front', x: 27, y: 95, severity: 'Medium', count: 7, type: 'Finishing' },
    { id: 7, component: 'Crotch Area', side: 'front', x: 50, y: 50, severity: 'Critical', count: 18, type: 'Stress Point' },
    { id: 8, component: 'Back Pocket Left', side: 'back', x: 35, y: 35, severity: 'Medium', count: 6, type: 'Stitching' },
    { id: 9, component: 'Right Side Seam', side: 'front', x: 65, y: 50, severity: 'Low', count: 4, type: 'Seam' },
    { id: 10, component: 'Inseam Right', side: 'back', x: 70, y: 80, severity: 'High', count: 9, type: 'Seam' },
  ];
  ...
  const stats = useMemo(() => {
    const totalDefects = mockDefectData.reduce((sum, item) => sum + item.count, 0);
    const criticalDefects = mockDefectData.filter(item => item.severity === 'Critical').reduce((sum, item) => sum + item.count, 0);
    const mostProblematicComponent = mockDefectData.reduce((max, item) => item.count > max.count ? item : max, { count: 0 });
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="opacity-90">Visual analytics for defect pattern identification</p>
          </div>
        ...
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              ...
              <option value="Critical" className="text-gray-800">Critical Only</option>
              <option value="High" className="text-gray-800">High Only</option>
              <option value="Medium" className="text-gray-800">Medium Only</option>
              <option value="Low" className="text-gray-800">Low Only</option>
            </select>
          </div>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-2/3 p-6">
          <div className="relative">
            {/* Trouser Silhouette */}
            <div className="relative mx-auto" style={{ maxWidth: '400px', height: '600px' }}>
              ...
              >
                ...
                {currentView === 'front' && (
                  <g>
                    {/* Waistband */}
                    <rect x="120" y="50" width="160" height="20" fill="#f8fafc" stroke="#e2e8f0" strokeWidth="2" rx="10"/>
                    
                    {/* Front panels */}
                    <path
                      d="M 130 70 L 270 70 L 280 200 L 300 400 L 320 580 L 280 580 L 260 400 L 240 300 L 200 300 L 160 300 L 140 400 L 120 580 L 80 580 L 100 400 L 120 200 L 130 70 Z"
                      fill="#ffffff"
                      stroke="#cbd5e1"
                      strokeWidth="3"
                    />
                    ...
                    {/* Pockets */}
                    <rect x="140" y="120" width="30" height="40" fill="#f1f5f9" stroke="#cbd5e1" strokeWidth="1" rx="5"/>
                    <rect x="230" y="120" width="30" height="40" fill="#f1f5f9" stroke="#cbd5e1" strokeWidth="1" rx="5"/>
                    
                    {/* Center seam */}
                    <line x1="200" y1="70" x2="200" y2="300" stroke="#e2e8f0" strokeWidth="1" strokeDasharray="5,5"/>
                    
                    {/* Inseam lines */}
                    <line x1="160" y1="300" x2="140" y2="580" stroke="#e2e8f0" strokeWidth="1"/>
                    <line x1="240" y1="300" x2="260" y2="580" stroke="#e2e8f0" strokeWidth="1"/>
                  </g>
                )}
                ...
                {currentView === 'back' && (
                  <g>
                    ...
                    {/* Back pockets */}
                    <rect x="150" y="140" width="25" height="35" fill="#f1f5f9" stroke="#cbd5e1" strokeWidth="1" rx="3"/>
                    <rect x="225" y="140" width="25" height="35" fill="#f1f5f9" stroke="#cbd5e1" strokeWidth="1" rx="3"/>
                    
                    {/* Back seam */}
                    <line x1="200" y1="70" x2="200" y2="580" stroke="#e2e8f0" strokeWidth="2"/>
                    
                    {/* Side seams */}
                    <line x1="130" y1="70" x2="120" y2="580" stroke="#e2e8f0" strokeWidth="1"/>
                    <line x1="270" y1="70" x2="280" y2="580" stroke="#e2e8f0" strokeWidth="1"/>
                  </g>
                )}
              </svg>
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: getHotspotColor(defect.severity, defect.count),
            ...
            <div className="mt-6 bg-gray-50 rounded-lg p-4">
              <h4 className="font-medium text-gray-800 mb-3">Heat Map Legend</h4>
