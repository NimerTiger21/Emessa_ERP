      ...
      <div className="max-w-7xl max-h-full mx-4 flex flex-col items-center">
        ...
        <div className="relative mb-6 group">
          <img
            ...
            className={`cursor-zoom-in max-w-full max-h-[75vh] object-contain rounded-lg shadow-2xl transition-transform duration-300 ${
          ...
          {/* Severity Badge */}
          <div
            className={`absolute top-4 right-4 px-3 py-2 rounded-full text-sm font-medium shadow-lg ${getSeverityColor(
          ...
          <div
            onClick={handleImageClick}
            className="absolute bottom-4 right-4 p-2 bg-black bg-opacity-50 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"
          >
