...
import { MdAdd, MdRemove, MdDelete, MdWarning, MdCheckCircle, MdLocationOn, MdBuild } from 'react-icons/md';
    ...
    <div className="border rounded-lg p-4 bg-gray-50">
        ...
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <div className="flex space-x-2">
            <button
              ...
              disabled={disabled || !defectPlaces.length || !defectProcesses.length}
            >
      ...
      {details.length > 0 && (
        <div className="mb-4">
          <div className="space-y-2">
            {details.map((detail) => (
              <div key={detail.id} className="flex items-center space-x-3 p-3 bg-white border rounded-lg">
                <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    type="button"
                    onClick={() => updateDetailCount(detail.id, detail.count - 1)}
                  ...
                  <span className="w-8 text-center font-medium">{detail.count}</span>
      ...
      {showAddForm && (
        <div className="border-t pt-4">
          <h5 className="font-medium text-gray-800 mb-3">Add New Location Detail</h5>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setNewDetail({...newDetail, count: parseInt(e.target.value) || 1})}
                className="w-full p-2 border border-gray-300 rounded text-sm"
                disabled={disabled}
              />
            </div>
          ...
          <div className="flex space-x-2">
            <button
              ...
              disabled={disabled || !newDetail.defectPlace || !newDetail.defectProcess || newDetail.count < 1}
            >
              Add Detail
            </button>
            <button
      ...
      <div className="mt-4 text-xs text-gray-500">
        <p>
          💡 <strong>Tip:</strong> Details help track exactly where defects occur. 
          The total count of all details must match your defect count ({totalCount}).
        </p>
      </div>
    </div>
  );
