...
const LogDefectModal = ({
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case "defectCount":
        if (!value || value < 1)
          errors.defectCount = "Count must be at least 1";
  ...
  const filteredDefectNames = defectNames?.filter(
  ...
  const getFieldClasses = (fieldName) => {
    const baseClasses =
      "w-full p-3 transition-all duration-200 border rounded focus:outline-none focus:ring-2";
      ...
      >
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex items-center">
              ...
              {index < steps.length - 1 && (
                <div
                  className={`mx-2 flex-grow h-0.5 ${
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>
                      You can upload up to 5 images to document the defect
                    </li>
        ...
        <form onSubmit={handleSubmit}>
            ...
            {currentStep === 1 && (
              ...
              >
                <h3 className="text-lg font-semibold mb-4 text-gray-700 flex items-center">
                  <span className="mr-2 bg-gray-200 text-gray-600 w-6 h-6 rounded-full text-xs flex items-center justify-center">
                    1
                  </span>
                  Basic Information
                </h3>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {touched.defectName && formErrors.defectName && (
                      <p className="mt-1 text-xs text-red-500">
                        {formErrors.defectName}
                      </p>
                    )}
                    {!formData.defectType && (
                      <p className="mt-1 text-xs text-gray-500">
                        First select a defect type
                      </p>
                    )}
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {touched.holesOrOperation &&
                        formErrors.holesOrOperation && (
                          <div className="absolute right-3 top-3 text-red-500">
                            <MdError size={20} />
                          </div>
                        )}
                  ...
                  <div>
                    ...
                    {touched.defectProcess && formErrors.defectProcess && (
                      <p className="mt-1 text-xs text-red-500">
                        {formErrors.defectProcess}
                      </p>
                    )}
                    {!formData.defectPlace && (
                      <p className="mt-1 text-xs text-gray-500">
                        First select a defect place
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <DatePicker
                          selected={
                            formData.detectedDate instanceof Date
                              ? formData.detectedDate
                              : new Date(formData.detectedDate)
                          }
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="mb-3 flex items-start bg-blue-50 p-3 rounded-md text-sm">
                      ...
                      <div className="text-blue-700">
                        <span className="font-medium">Image Tips:</span> Upload
                        clear, well-lit photos showing the defect. Maximum 5
                        images allowed (max 5MB each). Drag to reorder images.
                      </div>
                    </div>
                    ...
                    {activeImages.length > 0 ? (
                          ...
                          {activeImages.map((image, index) => (
                            ...
                            >
                              ...
                              <div className="flex justify-between items-center mt-1">
                                <div className="text-xs text-gray-500 truncate w-3/4">
                                  {image.name}
                                </div>
                                <button
                                  type="button"
                      ...
                      <div className="flex flex-col items-center justify-center bg-gray-100 border border-dashed border-gray-300 rounded-lg p-6 text-center">
                        ...
                        <p className="text-sm text-gray-400">
                          Add images to better document the defect
                        </p>
                      </div>
                    )}
                        ...
                        <div className="grid grid-cols-4 gap-2 bg-gray-100 p-2 rounded">
                          {trashedImages.map((image, index) => (
                            ...
                            >
                              ...
                              <div className="text-xs text-gray-600 truncate mt-1 text-center">
          ...
          {isImagePreviewOpen && previewImage && (
            ...
            >
              <div
                className="relative bg-white p-2 rounded max-w-2xl max-h-2xl"
          ...
          <div className="bg-gray-50 px-6 py-4 flex justify-between items-center border-t">
            ...
            {currentStep < 3 ? (
              ...
              <div className="ml-auto flex space-x-3">
                ...
                <button
                  type="submit"
                  className={`px-6 py-2 text-white rounded hover:bg-opacity-90 transition-colors flex items-center ${
