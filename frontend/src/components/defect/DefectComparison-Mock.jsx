        ...
        return {
          scatterData: [
            ...
            },
            {
              ...
              y: 1.7,
              z: 14,
              composition: "88% Cotton, 12% Elastane",
              defectType: "Size",
              severity: "Low",
            },
          ],
          compositionData: [
            ...
            {
              name: "75% Cotton, 25% Polyester",
              defectRate: 2.8,
              defectCount: 112,
            },
            {
              name: "82% Nylon, 18% Spandex",
              defectRate: 3.4,
              defectCount: 136,
            },
            { name: "60% Wool, 40% Acrylic", defectRate: 2.2, defectCount: 88 },
            {
              name: "95% Viscose, 5% Elastane",
              defectRate: 3.7,
              defectCount: 148,
            },
            {
              name: "50% Polyester, 50% Cotton",
              defectRate: 4.1,
              defectCount: 164,
            },
            {
              name: "88% Cotton, 12% Elastane",
              defectRate: 1.7,
              defectCount: 68,
            },
          ],
          ...
          {filters.comparisonType === "fabric-vs-style" && (
            <>
              <p className="font-semibold text-gray-800">
                {data.fabricName} - {data.styleName}
              </p>
    ...
    if (filters.comparisonType === "fabric-vs-style") {
        ...
        <>
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 h-96">
            <h3 className="text-lg font-medium text-gray-800 mb-4">
              Fabric vs Style Defect Correlation
            </h3>
            <ResponsiveContainer width="100%" height="90%">
              ...
              >
                ...
                <XAxis type="number" dataKey="x" name="Fabric Defects" unit="">
                  <Label value="Fabric Defects" position="bottom" offset={0} />
                </XAxis>
                <YAxis type="number" dataKey="y" name="Style Defects" unit="">
                  <Label
                    value="Style Defects"
                    position="left"
                    angle={-90}
      ...
      return (
        <>
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 h-96">
            <h3 className="text-lg font-medium text-gray-800 mb-4">
              Fabric Composition vs Defect Type
            </h3>
            <ResponsiveContainer width="100%" height="90%">
              <ScatterChart
                margin={{ top: 20, right: 20, bottom: 20, left: 20 }}
              >
                ...
                >
                  <Label
                    value="Natural Fiber Content (%)"
                    position="bottom"
                    offset={0}
                  />
                </XAxis>
                <YAxis type="number" dataKey="y" name="Defect Rate" unit="%">
                  <Label
                    value="Defect Rate (%)"
                    position="left"
                    angle={-90}
      ...
      return (
        <>
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 h-96">
            <h3 className="text-lg font-medium text-gray-800 mb-4">
              Defect Severity Trends Over Time
            </h3>
            <ResponsiveContainer width="100%" height="90%">
              <ComposedChart
              ...
              >
                ...
                <div className="mt-2 text-sm text-gray-500">
                  {item.severity === "High"
                    ...
                    : item.severity === "Medium"
                    ? "Significant issues affecting product quality"
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Compare relationships between different defect metrics and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-2 mb-4">
              ...
              >
                ...
                <option value="composition-vs-defect">
                  Composition vs Defect
                </option>
